...
/*
Does:
Call ActivateTask() from non-preemptive task on ready basic task which has not reached max. number of activations.
...
int main(void)
{
  ...
  EE_assert_summarize("BCC2 Modistarc Task Management (12)", result, ASSERTIONS);
