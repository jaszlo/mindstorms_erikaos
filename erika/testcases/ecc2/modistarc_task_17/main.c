...
/*
Does:
Call ActivateTask() from non-preemptive task on running basic task which has not reached max. number of activations.
...
int main(void)
{
  ...
  EE_assert_summarize("ECC2 Modistarc Task Management (17)", result, ASSERTIONS);
