...
/*
Does:
Call TerminateTask() from ISR category 3 i.e. value 2 in OIL
...
int main(void)
{
  ...
  EE_assert_summarize("BCC1 Modistarc Task Management (21)", result, ASSERTIONS);
