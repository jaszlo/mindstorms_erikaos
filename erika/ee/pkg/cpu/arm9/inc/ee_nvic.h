...
#ifndef __INCLUDE_ARM9_NVIC_H__
#define __INCLUDE_ARM9_NVIC_H__
...
#define NVIC_INT_PRI_M(_int) ( \
    (EE_UREG)0x000000E0 << (((EE_UREG)_int & NVIC_INT_PRI_REG_M) << NVIC_INT_PRI_REG_M))
...
#define NVIC_INT_PRI(_int, _pri) ( \
    ((EE_UREG)_pri << NVIC_INT_PRI_S) << (((EE_UREG)_int & NVIC_INT_PRI_REG_M) << NVIC_INT_PRI_REG_M))
...
#define NVIC_SET_PRI(_int, _pri)                                                      \
  {                                                                                   \
    NVIC_CLR_PRI(_int);                                                               \
    (                                                                                 \
        NVIC_INT_PRI_REG(_int) |= (NVIC_INT_PRI_M(_int) & NVIC_INT_PRI(_int, _pri))); \
  }

/* NVIC Get Priority */
#define NVIC_GET_PRI(_int) (                                                                                                \
    (                                                                                                                       \
        (NVIC_INT_PRI_REG(_int) & NVIC_INT_PRI_M(_int)) >> (((EE_UREG)_int & NVIC_INT_PRI_REG_M) << NVIC_INT_PRI_REG_M)) >> \
    NVIC_INT_PRI_S)
